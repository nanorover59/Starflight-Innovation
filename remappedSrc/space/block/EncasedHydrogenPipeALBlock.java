...
public class EncasedHydrogenPipeALBlock extends HydrogenPipeBlock
{
	protected EncasedHydrogenPipeALBlock(Settings settings)
	{
		super(settings);
	}
	...
	{
		return new EncasedHydrogenPipeALBlockEntity(pos, state);
	}
