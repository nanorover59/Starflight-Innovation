...
public class StarflightBlocks
{
	...
	public static final Block REACTION_WHEEL = new ReactionWheelBlock(FabricBlockSettings.copyOf(ALUMINUM_BLOCK), 50e3f);
	...
	public static final Block THRUSTER_INITIAL = new RocketThrusterBlock(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK), Block.createCuboidShape(0.01, 0.01, 0.01, 15.99, 15.99, 15.99), 0.25e6, 350, 300, 12.0);
	public static final Block THRUSTER_SMALL = new RocketThrusterBlock(FabricBlockSettings.copyOf(TITANIUM_BLOCK), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 15.99, 15.0), 0.15e6, 400, 350, 12.0);
	public static final Block THRUSTER_VACUUM = new RocketThrusterBlock(FabricBlockSettings.copyOf(TITANIUM_BLOCK), Block.createCuboidShape(0.0, -15.0, 0.0, 16.0, 15.99, 16.0), 0.075e6, 450, 200, 4.0);
	public static final Block AEROSPIKE = new RocketThrusterBlock(FabricBlockSettings.copyOf(TITANIUM_BLOCK), Block.createCuboidShape(1.0, 0.3, 1.0, 15.0, 15.99, 15.0), 0.15e6, 425, 400, 20.0);
	...
	public static final double HYDROGEN_TANK_CAPACITY = 40.0;
