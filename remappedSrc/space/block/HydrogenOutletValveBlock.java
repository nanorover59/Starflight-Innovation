...
public class HydrogenOutletValveBlock extends BlockWithEntity implements FluidUtilityBlock
{
	...
	{
		return validateTicker(type, StarflightBlocks.HYDROGEN_OUTLET_VALVE_BLOCK_ENTITY, (world1, pos, blockState, blockEntity) -> HydrogenOutletValveBlockEntity.tick(world1, pos, blockState, blockEntity));
	}
