...
public class CeruleanEntity extends TameableEntity implements Angerable
{
	...
	public void readCustomDataFromNbt(NbtCompound nbt)
	{
		...
		this.readAngerFromNbt(this.method_48926(), nbt);
	}
	...
	public ActionResult interactMob(PlayerEntity player, Hand hand)
	{
		...
		else if(!this.isTamed() && this.isBreedingItem(itemStack))
		{
			if(this.random.nextBoolean())
			{
				...
				this.method_48926().sendEntityStatus(this, EntityStatuses.ADD_POSITIVE_PLAYER_REACTION_PARTICLES);
				return ActionResult.SUCCESS;
			}
			else
				this.method_48926().sendEntityStatus(this, EntityStatuses.ADD_NEGATIVE_PLAYER_REACTION_PARTICLES);
		}
