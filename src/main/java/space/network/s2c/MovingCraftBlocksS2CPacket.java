...
public record MovingCraftBlocksS2CPacket(int entityID, ArrayList<MovingCraftBlockData> blockDataList) implements CustomPayload
{
    ...
    {
    	this(buffer.readInt(), buffer.readCollection(ArrayList::new, MovingCraftBlockData::new));
    }
