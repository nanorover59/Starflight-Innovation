...
public record RocketControllerDataS2CPacket(double[] stats, ArrayList<MovingCraftEntity.BlockRenderData> blockDataList) implements CustomPayload
{
    ...
    {
    	this(readDoubles(buffer), buffer.readCollection(ArrayList::new, MovingCraftEntity.BlockRenderData::new));
    }
