...
public class PlanetResourceListener implements SimpleResourceReloadListener<ArrayList<Planet>>
{
	...
	{
		return Identifier.of(StarflightMod.MOD_ID, "planets");
	}
	...
	private ArrayList<Planet> loadPlanetList(ResourceManager manager)
	{
				...
				while(reader.hasNext())
				{
					...
					else if(tagName.equals("dimensionData"))
					{
						...
						while(reader.hasNext())
						{
							...
							reader.endObject();
							Identifier identifier = Identifier.of(dimensionID);
