...
public class AdvancedFabricatorBlock extends BlockWithEntity implements EnergyBlock
{
	public static final MapCodec<AdvancedFabricatorBlock> CODEC = AdvancedFabricatorBlock.createCodec(AdvancedFabricatorBlock::new);
	public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
	public static final BooleanProperty LIT = Properties.LIT;
	
	public AdvancedFabricatorBlock(Settings settings)
	{
		super(settings);
	...
	@Override
	public MapCodec<? extends AdvancedFabricatorBlock> getCodec()
	{
		return CODEC;
	}
	...
	public void openScreen(World world, BlockPos pos, PlayerEntity player)
	{
		...
		if(blockEntity instanceof AdvancedFabricatorBlockEntity)
			player.openHandledScreen((AdvancedFabricatorBlockEntity) blockEntity);
	}
		...
		if(!state.isOf(newState.getBlock()))
		{
			...
			if(blockEntity instanceof AdvancedFabricatorBlockEntity)
			{
				if(world instanceof ServerWorld)
					ItemScatterer.spawn(world, (BlockPos) pos, (Inventory) ((AdvancedFabricatorBlockEntity) blockEntity));
	...
	{
		return world.isClient ? null : validateTicker(type, StarflightBlocks.ADVANCED_FABRICATOR_BLOCK_ENTITY, AdvancedFabricatorBlockEntity::serverTick);
	}
}