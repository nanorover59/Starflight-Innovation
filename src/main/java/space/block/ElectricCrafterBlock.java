...
public class ElectricCrafterBlock extends BlockWithEntity implements EnergyBlock
{
	public static final MapCodec<ElectricCrafterBlock> CODEC = ElectricCrafterBlock.createCodec(ElectricCrafterBlock::new);
	public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
	public static final BooleanProperty LIT = Properties.LIT;
	
	public ElectricCrafterBlock(Settings settings)
	{
		super(settings);
	...
	@Override
	public MapCodec<? extends ElectricCrafterBlock> getCodec()
	{
		return CODEC;
	}
	...
	public void openScreen(World world, BlockPos pos, PlayerEntity player)
	{
		...
		if(blockEntity instanceof ElectricCrafterBlockEntity)
			player.openHandledScreen((ElectricCrafterBlockEntity) blockEntity);
	}
		...
		if(!state.isOf(newState.getBlock()))
		{
			...
			if(blockEntity instanceof ElectricCrafterBlockEntity)
			{
				if(world instanceof ServerWorld)
					ItemScatterer.spawn(world, (BlockPos) pos, (Inventory) ((ElectricCrafterBlockEntity) blockEntity));
	...
	{
		return new ElectricCrafterBlockEntity(pos, state);
	}
	...
	{
		return world.isClient ? null : validateTicker(type, StarflightBlocks.ELECTRIC_CRAFTER_BLOCK_ENTITY, ElectricCrafterBlockEntity::serverTick);
	}
}