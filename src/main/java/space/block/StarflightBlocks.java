...
public class StarflightBlocks
{
	...
	public static final Block SOLARIZED_REGOLITH = new ColoredFallingBlock(new ColorCode(-8356741), AbstractBlock.Settings.copy(Blocks.GRAVEL).mapColor(MapColor.STONE_GRAY).strength(0.5F));
	public static final Block SEARING_REGOLITH = new ColoredFallingBlock(new ColorCode(-8356741), AbstractBlock.Settings.copy(Blocks.GRAVEL).mapColor(MapColor.ORANGE).strength(0.5F));
