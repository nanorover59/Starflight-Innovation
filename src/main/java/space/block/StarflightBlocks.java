...
public class StarflightBlocks
{
	...
	public static final Block RIVETED_IRON = new Block(AbstractBlock.Settings.copy(STRUCTURAL_IRON));
	...
	public static final Block IRON_MACHINE_CASING = new Block(AbstractBlock.Settings.copy(STRUCTURAL_IRON));
	public static final Block STRUCTURAL_IRON_PILLAR = new PillarBlock(AbstractBlock.Settings.copy(STRUCTURAL_IRON));
	public static final Block IRON_LIGHT_PILLAR = new PillarBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).luminance(state -> 10).sounds(BlockSoundGroup.COPPER));
	...
	public static final Block LUNAR_LAMP = new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.CYAN).luminance(state -> 15));
	...
	public static final Block TESSARITE_BRICKS = new Block(AbstractBlock.Settings.copy(REDSLATE));
	public static final Block TESSARITE_BRICK_STAIRS = new StairsBlock(TESSARITE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(TESSARITE_BRICKS));
	public static final Block TESSARITE_BRICK_SLAB = new SlabBlock(AbstractBlock.Settings.copy(TESSARITE_BRICKS));
	...
	public static final Block ELECTRIC_CRAFTER = new ElectricCrafterBlock(AbstractBlock.Settings.copy(ALUMINUM_BLOCK).luminance(createLightLevelFromLitBlockState(7)));
	...
	public static final Block ADVANCED_FABRICATOR = new AdvancedFabricatorBlock(AbstractBlock.Settings.copy(TITANIUM_BLOCK).luminance(createLightLevelFromLitBlockState(7)));
	...
	public static final Block ENGINE_0 = new RocketThrusterBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.ANVIL), 1.0e6, 300, 280, 0.0);
	public static final Block ENGINE_1 = new RocketThrusterBlock(AbstractBlock.Settings.copy(TITANIUM_BLOCK), 1.0e6, 350, 320, 0.0);
	public static final Block ENGINE_1_GIMBAL = new RocketThrusterBlock(AbstractBlock.Settings.copy(TITANIUM_BLOCK), 0.8e6, 350, 320, Math.PI / 16.0);
	public static final Block ENGINE_1_EXTENSION = new RocketThrusterExtensionBlock(AbstractBlock.Settings.copy(TITANIUM_BLOCK), 1.15, 0.75);
	...
	public static final BlockEntityType<ElectricCrafterBlockEntity> ELECTRIC_CRAFTER_BLOCK_ENTITY = BlockEntityType.Builder.create(ElectricCrafterBlockEntity::new, ELECTRIC_CRAFTER).build(null);
	...
	public static final BlockEntityType<ElectricLightBlockEntity> ELECTRIC_LIGHT_BLOCK_ENTITY = BlockEntityType.Builder.create(ElectricLightBlockEntity::new, LIGHT_COLUMN).build(null);
	...
	public static final BlockEntityType<AdvancedFabricatorBlockEntity> ADVANCED_FABRICATOR_BLOCK_ENTITY = BlockEntityType.Builder.create(AdvancedFabricatorBlockEntity::new, ADVANCED_FABRICATOR).build(null);
	...
	public static void initializeBlocks()
	{
		...
		initializeBlock(RIVETED_IRON, "riveted_iron");
		...
		initializeBlock(STRUCTURAL_IRON_PILLAR, "structural_iron_pillar");
		initializeBlock(IRON_LIGHT_PILLAR, "iron_light_pillar");
		...
		initializeBlock(TESSARITE_BRICKS, "tessarite_bricks");
		initializeBlock(TESSARITE_BRICK_STAIRS, "tessarite_brick_stairs");
		initializeBlock(TESSARITE_BRICK_SLAB, "tessarite_brick_slab");
		...
		initializeBlock(ELECTRIC_CRAFTER, "electric_crafter");
		initializeBlock(ADVANCED_FABRICATOR, "advanced_fabricator");
		initializeBlock(PUMP, "pump");
		initializeBlock(METAL_FABRICATOR, "metal_fabricator", false, List.of(), List.of());
		...
		initializeBlock(ENGINE_1_EXTENSION, "engine_1_extension");
		...
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(StarflightMod.MOD_ID, "electric_crafter"), ELECTRIC_CRAFTER_BLOCK_ENTITY);
		...
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(StarflightMod.MOD_ID, "advanced_fabricator"), ADVANCED_FABRICATOR_BLOCK_ENTITY);
