...
public class StarflightBlocks
{
	...
	public static final Block REINFORCED_PANEL_STAIRS = new StairsBlock(REINFORCED_PANELS.getDefaultState(), AbstractBlock.Settings.copy(REINFORCED_PANELS));
	public static final Block REINFORCED_PANEL_SLAB = new SlabBlock(AbstractBlock.Settings.copy(REINFORCED_PANELS));
	public static final Block REINFORCED_WALL = new WallBlock(AbstractBlock.Settings.copy(REINFORCED_PANELS));
	public static final Block REINFORCED_ROUND_DECO = new Block(AbstractBlock.Settings.copy(REINFORCED_PANELS));
	...
	public static final Block TITANIUM_PANELS = new Block(AbstractBlock.Settings.copy(TITANIUM_BLOCK));
	public static final Block TITANIUM_PANEL_STAIRS = new StairsBlock(TITANIUM_PANELS.getDefaultState(), AbstractBlock.Settings.copy(TITANIUM_PANELS));
	public static final Block TITANIUM_PANEL_SLAB = new SlabBlock(AbstractBlock.Settings.copy(TITANIUM_PANELS));
	public static final Block TITANIUM_WALL = new WallBlock(AbstractBlock.Settings.copy(TITANIUM_PANELS));
	public static final Block DAMAGED_TITANIUM_PANELS = new Block(AbstractBlock.Settings.copy(TITANIUM_BLOCK));
	...
	public static final Block METAL_FABRICATOR = new MetalFabricatorBlock(AbstractBlock.Settings.copy(TITANIUM_BLOCK).luminance(createLightLevelFromLitBlockState(5)));
	...
	public static final TagKey<Block> EXCLUDED_BLOCK_TAG = TagKey.of(RegistryKeys.BLOCK, Identifier.of(StarflightMod.MOD_ID, "excluded_blocks"));
	...
	public static final TagKey<Block> AIR_UPDATE_TAG = TagKey.of(RegistryKeys.BLOCK, Identifier.of(StarflightMod.MOD_ID, "air_update_blocks"));
	...
	public static void initializeBlocks()
	{
		...
		initializeBlock(REINFORCED_PANELS, "reinforced_panels");
		initializeBlock(REINFORCED_PANEL_STAIRS, "reinforced_panel_stairs");
		initializeBlock(REINFORCED_PANEL_SLAB, "reinforced_panel_slab");
		initializeBlock(REINFORCED_WALL, "reinforced_wall");
		initializeBlock(REINFORCED_ROUND_DECO, "reinforced_round_deco");
		...
		initializeBlock(DAMAGED_TITANIUM_PANELS, "damaged_titanium_panels", false, List.of(), List.of());
		initializeBlock(TITANIUM_PANEL_STAIRS, "titanium_panel_stairs");
		initializeBlock(TITANIUM_PANEL_SLAB, "titanium_panel_slab");
		initializeBlock(TITANIUM_WALL, "titanium_wall");
