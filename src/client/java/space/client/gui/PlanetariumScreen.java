...
public class PlanetariumScreen extends HandledScreen<ScreenHandler>
{
	...
	protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY)
	{
		...
		context.drawTexture(TEXTURE, button1X, button1Y, canSelectPlanet ? (button1Hover ? 36 : 18) : 0, 222, 18, 18);
		int button2X = x + 7;
		int button2Y = y + 59;
		boolean button2Hover = mouseX >= button2X && mouseX < button2X + 18 && mouseY >= button2Y && mouseY < button2Y + 18;
		context.drawTexture(TEXTURE, button2X, button2Y, canSelectPlanet ? (button2Hover ? 90 : 72) : 54, 222, 18, 18);
		int button3X = x + 7;
		int button3Y = y + 79;
		boolean button3Hover = mouseX >= button3X && mouseX < button3X + 18 && mouseY >= button3Y && mouseY < button3Y + 18;
		context.drawTexture(TEXTURE, button3X, button3Y, button3Hover ? 126 : 108, 222, 18, 18);
		int button4X = x + 7;
		int button4Y = y + 99;
		boolean button4Hover = mouseX >= button4X && mouseX < button4X + 18 && mouseY >= button4Y && mouseY < button4Y + 18;
		context.drawTexture(TEXTURE, button4X, button4Y, button4Hover ? 162 : 144, 222, 18, 18);
		MutableText text = Text.translatable("planet.space." + selectedPlanet.getName());
		context.drawTextWithShadow(textRenderer, text, (int) x + 32, (int) y + 20, 0x55FF55);
		...
		if(viewData)
		{
			...
			context.drawTextWithShadow(textRenderer, text, (int) x + 32, (int) y + 33, 0x55FF55);
			text = Text.translatable("block.space.deltav_to_orbit").append(df.format(selectedPlanet.dVOrbit) + "m/s");
			context.drawTextWithShadow(textRenderer, text, (int) x + 32, (int) y + 46, 0x55FF55);
			text = Text.translatable("block.space.deltav_to_surface").append(df.format(selectedPlanet.dVSurface) + "m/s");
			context.drawTextWithShadow(textRenderer, text, (int) x + 32, (int) y + 59, 0x55FF55);
		}
