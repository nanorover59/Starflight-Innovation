...
public class SpaceTravelScreen extends Screen
{
	...
	public SpaceTravelScreen(double deltaV)
	{
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta)
	{
        ...
        if(selectedPlanet != currentPlanet)
        {
	        ...
	        {
	        	text = Text.translatable("planet.space." + selectedPlanet.getName());
	        	x = width - (textRenderer.getWidth(text) + MARGIN);
	        	context.drawTextWithShadow(textRenderer, text, x, y, GREEN);
	        }
        }
		...
		if(nothingSelected && !viewData && !mouseHold && selectedPlanet.parent != null)
		{
